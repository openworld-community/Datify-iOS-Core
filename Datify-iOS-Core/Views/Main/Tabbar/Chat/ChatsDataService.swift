...
final class ChatsDataService: ObservableObject {
    ...
    private func createChatExamples() {
        let chat1 = ChatModel(participantId1: "0", participantId2: "1", messages: createSampleMessages(for: ["0", "1"]))
        let chat2 = ChatModel(participantId1: "0", participantId2: "2", messages: createSampleMessages(for: ["0", "2"]))
        let chat3 = ChatModel(participantId1: "0", participantId2: "3", messages: createSampleMessages(for: ["0", "3"]))
